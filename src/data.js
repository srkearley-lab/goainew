...
DATA.industries = [
  { id: 'villa-rentals', icon: 'House', label: { EN: 'Villa Rentals', GR: 'Βίλες' },
    ...
    description: { EN: "Villa owners in Greece face a flood of enquiries during peak season across WhatsApp, email and Instagram simultaneously.", GR: 'Οι ιδιοκτήτες βιλών στην Ελλάδα δέχονται καταιγισμό αιτημάτων στην peak σεζόν ταυτόχρονα σε WhatsApp, email και Instagram.' },
    painPoint: { EN: '"We get 40 WhatsApp messages a day in July. Half of them never get a proper reply because we\'re busy with guests already staying."', GR: '«Τον Ιούλιο δεχόμαστε 40 μηνύματα WhatsApp την ημέρα. Τα μισά δεν παίρνουν ποτέ σωστή απάντηση γιατί είμαστε απασχολημένοι με τους επισκέπτες.»' },
    builds: [
  ...
  { id: 'gyms-fitness', icon: 'Dumbbell', label: { EN: 'Gyms & Fitness', GR: 'Γυμναστήρια' },
    ...
    description: { EN: "Gym owners pour money into Instagram but can't track what converts. Trial memberships start strong then drop off.", GR: 'Οι ιδιοκτήτες γυμναστηρίων ξοδεύουν στο Instagram αλλά δεν ξέρουν τι αποδίδει. Οι δοκιμαστικές συνδρομές ξεκινούν δυνατά και μετά χάνονται.' },
    ...
    builds: [
      ...
      { icon: 'Search', label: { EN: 'Local SEO', GR: 'Τοπικό SEO' }, detail: { EN: 'Rank for "gym [city]", "personal trainer [area]"', GR: 'Κατάταξη για «γυμναστήριο [πόλη]», «personal trainer [περιοχή]»' } },
  ...
  { id: 'restaurants', icon: 'UtensilsCrossed', label: { EN: 'Restaurants', GR: 'Εστιατόρια' },
    ...
    description: { EN: "Restaurants in Greek tourist areas are fully booked in summer but struggle mid-week and shoulder season.", GR: 'Τα εστιατόρια σε τουριστικές περιοχές γεμίζουν το καλοκαίρι αλλά δυσκολεύονται μεσοβδόμαδα και εκτός σεζόν.' },
    painPoint: { EN: '"We have 40 empty covers on Tuesday nights in May while the tourist traps down the road are full — even though our food is much better."', GR: '«Έχουμε 40 άδεια τραπέζια τις Τρίτες τον Μάιο, ενώ οι τουριστικές παγίδες δίπλα είναι γεμάτες.»' },
    builds: [
  ...
  { id: 'cafes', icon: 'Coffee', label: { EN: 'Cafés', GR: 'Καφετέριες' },
    ...
    description: { EN: 'Cafés live and die by foot traffic and word of mouth. But tourists in Greece increasingly check Google before they walk in.', GR: 'Οι καφετέριες ζουν από την κίνηση και το από στόμα σε στόμα. Όμως οι τουρίστες ελέγχουν όλο και περισσότερο το Google πριν μπουν.' },
    painPoint: { EN: '"Someone walked in and said they almost didn\'t come because our Google photos look nothing like the café does now."', GR: '«Κάποιος μπήκε και είπε ότι παραλίγο να μην έρθει, γιατί οι φωτογραφίες μας στο Google δεν έχουν καμία σχέση.»' },
    builds: [
  ...
  { id: 'hair-beauty', icon: 'Scissors', label: { EN: 'Hair & Beauty', GR: 'Κομμωτήρια & Beauty' },
    ...
    description: { EN: "Salons lose revenue to no-shows, last-minute cancellations and clients who forget to rebook.", GR: 'Τα κομμωτήρια χάνουν έσοδα από no-shows, ακυρώσεις τελευταίας στιγμής και πελάτες που ξεχνούν να ξανακλείσουν.' },
    ...
    builds: [
      ...
      { icon: 'Search', label: { EN: 'Local SEO', GR: 'Τοπικό SEO' }, detail: { EN: 'Rank for "hair salon [city]", "balayage [area]"', GR: 'Κατάταξη για «κομμωτήριο [πόλη]», «balayage [περιοχή]»' } },
  ...
  { id: 'tourism', icon: 'Map', label: { EN: 'Tourism Companies', GR: 'Τουριστικές Επιχειρήσεις' },
    ...
    description: { EN: 'Tour operators in Greece spend hours answering the same questions, writing custom proposals and chasing payment confirmations.', GR: 'Οι tour operators στην Ελλάδα χάνουν ώρες απαντώντας στις ίδιες ερωτήσεις, γράφοντας προτάσεις και κυνηγώντας επιβεβαιώσεις πληρωμών.' },
    painPoint: { EN: '"Every group enquiry means 10 emails back and forth before we even confirm the price."', GR: '«Κάθε ομαδικό αίτημα σημαίνει 10 email πέρα-δώθε πριν καν επιβεβαιώσουμε τιμή.»' },
    builds: [
      ...
      { icon: 'Search', label: { EN: 'International SEO', GR: 'Διεθνές SEO' }, detail: { EN: 'Rank for "[tour type] Greece", "[island] tours"', GR: 'Κατάταξη για «[εκδρομή] Greece», «[νησί] tours»' } },
  ...
  { id: 'car-hire', icon: 'Car', label: { EN: 'Car Hire', GR: 'Ενοικιάσεις Αυτοκινήτων' },
    ...
    description: { EN: "Car hire companies in Greece compete head-to-head with OTAs and aggregators that dominate Google.", GR: 'Οι εταιρείες ενοικίασης αυτοκινήτων στην Ελλάδα ανταγωνίζονται απευθείας OTAs και aggregators που κυριαρχούν στο Google.' },
    ...
    builds: [
      ...
      { icon: 'Search', label: { EN: 'Google Ads for high-intent searches', GR: 'Google Ads για στοχευμένες αναζητήσεις' }, detail: { EN: '"car hire [island]", "rent a car [airport]"', GR: '«car hire [νησί]», «rent a car [αεροδρόμιο]»' } },
  ...
  { id: 'boat-hire', icon: 'Anchor', label: { EN: 'Boat Hire', GR: 'Ενοικιάσεις Σκαφών' },
    ...
    description: { EN: 'Boat hire and charter businesses in Greece pay 20–30% to platforms for every booking.', GR: 'Οι επιχειρήσεις ενοικίασης σκαφών στην Ελλάδα πληρώνουν 20–30% στις πλατφόρμες για κάθε κράτηση.' },
    painPoint: { EN: '"GetYourGuide sent us 60% of our bookings last season. We gave away €18,000 in commission."', GR: '«Το GetYourGuide μας έφερε το 60% των κρατήσεων πέρσι. Δώσαμε €18.000 σε προμήθειες.»' },
    builds: [
...
DATA.autoSections = [
  { cid: 'whatsapp-automation', tag: { EN: 'WhatsApp Automation', GR: 'WhatsApp Αυτοματισμός' }, title: { EN: 'Reply to every enquiry instantly — without lifting a finger', GR: 'Απαντήστε σε κάθε αίτημα άμεσα — χωρίς κόπο' },
    description: { EN: "Most businesses in Greece lose bookings because they can't respond to WhatsApp messages fast enough during peak season.", GR: 'Οι περισσότερες επιχειρήσεις στην Ελλάδα χάνουν κρατήσεις γιατί δεν προλαβαίνουν να απαντήσουν στα μηνύματα WhatsApp στην peak σεζόν.' },
    points: [
  ...
  { cid: 'email-automation', tag: { EN: 'Email Automation', GR: 'Email Αυτοματισμός' }, title: { EN: 'Turn cold enquiries into paying customers — automatically', GR: 'Μετατρέψτε ψυχρά αιτήματα σε πελάτες — αυτόματα' },
    description: { EN: 'Most leads go cold because no one followed up. Our email sequences keep your business in front of potential customers from day one.', GR: 'Τα περισσότερα leads κρυώνουν γιατί κανείς δεν έκανε follow-up. Οι ακολουθίες email μας κρατούν την επιχείρησή σας μπροστά στους υποψήφιους πελάτες.' },
    points: [
  ...
  { cid: 'ai-proposal-generation', tag: { EN: 'AI Proposals', GR: 'AI Προτάσεις' }, title: { EN: 'Send polished proposals in seconds, not hours', GR: 'Στείλτε άρτιες προτάσεις σε δευτερόλεπτα, όχι ώρες' },
    description: { EN: "Writing a custom proposal for every group enquiry takes time you don't have. Our AI generates a professional, branded proposal.", GR: 'Το να γράφετε custom πρόταση για κάθε ομαδικό αίτημα τρώει χρόνο που δεν έχετε. Το AI μας δημιουργεί μια επαγγελματική, branded πρόταση.' },
    points: [
...
DATA.supportCards = [
  { cid: 'local-seo', icon: 'Search', title: { EN: 'Local SEO', GR: 'Τοπικό SEO' }, description: { EN: 'We optimise your site and Google Business profile so you rank for local searches.', GR: 'Βελτιστοποιούμε το site και το Google Business profile σας ώστε να κατατάσσεστε σε τοπικές αναζητήσεις.' }, points: [{ EN: 'Google Business optimisation', GR: 'Βελτιστοποίηση Google Business' }, { EN: 'Monthly keyword reporting', GR: 'Μηνιαία αναφορά λέξεων-κλειδιών' }, { EN: 'Schema markup and technical SEO', GR: 'Schema markup και τεχνικό SEO' }, { EN: 'Competitor gap tracking', GR: 'Παρακολούθηση ανταγωνισμού' }] },
...
DATA.faqs = [
  { q: { EN: 'How long does it take to build my website?', GR: 'Πόσο χρόνο παίρνει η κατασκευή της ιστοσελίδας μου;' }, a: { EN: 'Most websites go live within 7 days of you confirming the brief. Simpler sites can be live in 4 days. Complex builds with automation and multiple languages take up to 10 days.', GR: 'Οι περισσότερες ιστοσελίδες βγαίνουν online μέσα σε 7 ημέρες από την επιβεβαίωση του brief. Πιο απλά sites σε 4 ημέρες. Πιο σύνθετα, με αυτοματισμούς, έως 10 ημέρες.' } },
  { q: { EN: 'Do I need to provide photos or write any content?', GR: 'Χρειάζεται να δώσω φωτογραφίες ή να γράψω περιεχόμενο;' }, a: { EN: "No. We handle all content writing using AI, tailored to your specific business and industry. For photos we use high-quality licensed stock images that match your brand.", GR: 'Όχι. Αναλαμβάνουμε όλο το περιεχόμενο με AI, προσαρμοσμένο στην επιχείρηση και τον κλάδο σας. Για φωτογραφίες χρησιμοποιούμε υψηλής ποιότητας licensed stock.' } },
  { q: { EN: 'What if I want changes after the website goes live?', GR: 'Τι γίνεται αν θέλω αλλαγές αφού βγει η ιστοσελίδα online;' }, a: { EN: "Growth and Premium plan clients get unlimited updates via WhatsApp — just message us and it's done, usually the same day.", GR: 'Οι πελάτες Growth και Premium έχουν απεριόριστες ενημερώσεις μέσω WhatsApp — απλά στείλτε μήνυμα και γίνεται, συνήθως την ίδια μέρα.' } },
  { q: { EN: 'Do I need any technical knowledge to manage things?', GR: 'Χρειάζομαι τεχνικές γνώσεις για να τα διαχειρίζομαι;' }, a: { EN: 'None at all. You manage every aspect of your digital presence through a single WhatsApp message to our team. No dashboards to log into, no software to learn.', GR: 'Καμία απολύτως. Διαχειρίζεστε κάθε πτυχή της ψηφιακής σας παρουσίας με ένα μήνυμα WhatsApp στην ομάδα μας.' } },
  { q: { EN: 'Is there a minimum contract length?', GR: 'Υπάρχει ελάχιστη διάρκεια συμβολαίου;' }, a: { EN: "Monthly plans have no minimum contract. You can cancel any time with 30 days' notice and keep everything we've built.", GR: 'Τα μηνιαία πλάνα δεν έχουν ελάχιστη διάρκεια. Μπορείτε να ακυρώσετε οποτεδήποτε με προειδοποίηση 30 ημερών και κρατάτε ό,τι έχουμε φτιάξει.' } },
  { q: { EN: 'Can you improve my existing website instead of building a new one?', GR: 'Μπορείτε να βελτιώσετε την υπάρχουσα ιστοσελίδα μου αντί για νέα;' }, a: { EN: "Yes — if your current site has good bones, we can rebuild or redesign it rather than start from scratch.", GR: 'Ναι — αν το υπάρχον site έχει καλή βάση, μπορούμε να το ανακατασκευάσουμε ή να το επανασχεδιάσουμε αντί να ξεκινήσουμε από την αρχή.' } },
  { q: { EN: 'Do you only work with businesses in Greece?', GR: 'Συνεργάζεστε μόνο με επιχειρήσεις στην Ελλάδα;' }, a: { EN: "Our primary focus is businesses operating in Greece — particularly those serving tourists or local Greek customers.", GR: 'Η κύρια εστίασή μας είναι επιχειρήσεις που λειτουργούν στην Ελλάδα — ιδίως όσες εξυπηρετούν τουρίστες ή τοπικούς πελάτες.' } },
];
